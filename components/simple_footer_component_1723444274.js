...
*/
Vue.component("simple_footer_component_1723444274", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            FunMaker - Let the Good Times Roll!
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Created by fun-lovers for fun-seekers everywhere. Bringing smiles and laughter to people of all ages through engaging activities and games. Join the FunMaker community today!
                    </div>
                </div>
            </div>
        </footer> 
